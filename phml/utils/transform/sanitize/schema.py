...
class Schema:
    ...
    ancestors: dict[str, list] = field(default_factory=lambda:{
        "tbody": ['table'],
        "tfoot": ['table'],
        "thead": ['table'],
        "td": ['table'],
    ...
    protocols: dict[str, list] = field(default_factory=lambda:{
        "href": ['http', 'https', 'mailto', 'xmpp', 'irc', 'ircs'],
        "cite": ['http', 'https'],
        "src": ['http', 'https'],
        "longDesc": ['http', 'https'],
    })
    tagNames: list[str] = field(default_factory=lambda:[
        'h1',
        'h2',
        'h3',
        'h4',
    ...
    attributes: dict[str, list[str | list[str]]] = field(default_factory=lambda:{
        "a": ['href'],
        "img": ['src', 'longDesc'],
    ...
    required: dict[str, str | list[str]] = field(default_factory=lambda:{
        "input": {
            "type": 'checkbox',
            "disabled": True,
        }
