...
from phml.utils.validate import *
...
class TestValidate:
    ...
    def test_validate(self):
        ...
        with raises(
            AssertionError,
            match="Children must be a node type"
        ):
            validate(sample)
        ...
        with raises(
            AssertionError,
            match="Node must be of type 'element' to contain 'properties'"
        ):
            validate(prop)
        ...
        with raises(
            AssertionError,
            match="Node 'properties' must be of type 'int' or 'str'"
        ):
            validate(prop)
        ...
        with raises(
            AssertionError,
            match="Node 'value' must be of type 'str'"
        ):
            validate(prop)
    ...
    def test_parent(self):
        ...
        with raises(
            AssertionError,
            match="Parent nodes should have the 'children' attribute"
        ):
            el = p("div")
            el.children = None
            parent(el)
        ...
        with raises(
            AssertionError,
            match="Parent element node shoudl have the 'properties' element."
        ):
            el = p("div")
            el.properties = None
            parent(el)
    ...
    def test_literal(self):
        ...
        with raises(
            AssertionError,
            match="Literal nodes 'value' type should be 'str'"
        ):
            el = p("text", "3")
            el.value = 3
            literal(el)
